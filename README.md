...
<div style="margin-top:2px; font-size:14px; line-height:1.5;">
...
<div style=" margin-top:15px; font-size:14px; line-height:1.6; background:#f7f7f7; padding:12px; border-left:4px solid 04aad; 
  border-radius:4px; ">
  <strong>Data-driven MHD Simulation of the Solar Eruption (Initialized from NLFFF)</strong><br>
